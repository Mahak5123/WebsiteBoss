...
<body>
    ...
    <section class="about-section">
        ...
        <div class="about-content">
            ...
            <div class="about-card">
                ...
                <p><strong>Owner:</strong> ${businessData.ownerName || 'Business Owner'}</p>
                <p><strong>Type:</strong> ${businessData.businessType || selectedIndustry}</p>
                <p><strong>Address:</strong> ${businessData.address || 'Please contact us for location'}</p>
            </div>
        </div>
    </section>
    ...
    <footer class="footer">
        ...
        <div style="border-top: 1px solid rgba(255,255,255,0.2); padding-top: 24px; margin-top: 24px;">
            <p style="opacity: 0.7;">© 2024 ${businessData.businessName || 'My Business'}. All rights reserved. | Generated by WebsiteBoss.com</p>
        </div>
    </footer>
</body>
</html>`;
        ...
        <section style={styles.aboutSection}>
          ...
          <div style={styles.aboutContent}>
            <div style={styles.aboutCard}>
              ...
              <p style={styles.cardText}>{businessData.businessDescription || 'We are committed to providing excellent products and services to our customers.'}</p>
            ...
            <div style={styles.aboutCard}>
              ...
              <p style={styles.cardText}>{businessData.servicesOffered || 'We offer a wide range of quality products and services.'}</p>
              {businessData.targetAudience && (
                <p style={{ marginTop: '16px', color: theme.primary, fontWeight: '500' }}>
                  <strong>Target Audience: {businessData.targetAudience}</strong>
                </p>
              )}
            </div>
            ...
            <div style={styles.aboutCard}>
              ...
              <p style={styles.cardText}><strong>Owner:</strong> {businessData.ownerName || 'Business Owner'}</p>
              <p style={styles.cardText}><strong>Type:</strong> {businessData.businessType || selectedIndustry}</p>
              <p style={styles.cardText}><strong>Address:</strong> {businessData.address || 'Please contact us for location'}</p>
            </div>
          </div>
        </section>
